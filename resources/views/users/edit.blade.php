                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nis') is-invalid @enderror" id="exampleInputNis" placeholder="NIS/NIP/NUPTK" name="nis" value="{{$user->nis ?? old('nis')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputName" placeholder="Full Name" name="name" value="{{$user->name ?? old('name')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('level') is-invalid @enderror" id="exampleInputlevel" name="level">
                                ...
                                <option value="kepsek" @if($user->level == 'kepsek' || old('level') == 'kepsek') selected @endif>Kepala Sekolah</option>
